...
int main(int argc, char **argv) {
    ...
    GetRelativeDistinguishedName("CN", commonName, "Common Name");
    GetRelativeDistinguishedName("O", organization, "Organization");    /* Full description passed in as third parameter */
    GetRelativeDistinguishedName("C", country, "Country");
 ...
 *
******************************************************/
int GetRelativeDistinguishedName(char *rdnAttribute, char *rdnValue, char *rdnDescription) {    /* Full description handled as third parameter  */
    int result = -1;
    rdnValue[0] = '\0';

    printf("Please enter the value for %s(%s): ", rdnDescription, rdnAttribute);    /* Prompts user with full description */
